...
export const SKILLS = [
  {
    ...
    summary: "AEM delivery, authoring, repository, and cloud operations.",
    items: [
      "AEM Cloud Service",
      "Edge Delivery (EDS)",
      "AEM 6.x",
  ...
  },
  {
    ...
    summary: "Customer data, journeys, identity, governance, and activation.",
    items: [
  ...
  {
    category: "FRONTEND",
    summary: "Component UIs, browser performance, and secure rendering.",
    items: [
      "React",
      "JavaScript ES6+",
      "Angular 6",
  ...
  },
  {
    ...
    summary: "Java services, APIs, search, pipelines, and cloud runtime.",
    items: [
      "Java",
      "Apache Sling",
      "REST APIs",
  ...
  {
    category: "PRACTICES",
    summary: "Delivery discipline, accessibility, security, privacy, and docs.",
    items: [
      "CI / CD",
      "ADA / a11y",
      "SEO",
...
export const SKILL_DESCRIPTIONS = {
  "AEM 6.x": "Classic enterprise AEM delivery across components, OSGi, dispatcher, and authoring workflows.",
  "AEM Cloud Service": "Cloud-native AEM with modern pipelines, scalable publish tiers, and Adobe-managed operations.",
  "Edge Delivery (EDS)": "CDN-first content delivery for faster TTFB and lean authoring workflows.",
  "HTL / Sightly": "Secure AEM templating for authorable component markup.",
  "Sling Models": "Typed Java models that map AEM content into reusable component data.",
  "OSGi / Felix": "Modular Java services, configurations, and lifecycle management inside AEM.",
  JCR: "Repository modeling, queries, permissions, and content storage for AEM.",
  CRXDE: "Repository-level inspection and debugging for AEM nodes and components.",
  "Touch UI": "Modern AEM dialogs and authoring interfaces for editor-friendly workflows.",
  DAM: "Asset metadata, renditions, workflows, search, and enterprise media delivery.",
  "Journey Optimizer (AJO)": "Event-driven journeys, decisioning, and cross-channel customer orchestration.",
  "Real-Time CDP (B2C/B2B/B2P)": "Unified profiles, audiences, identity strategy, and activation.",
  "Customer Journey Analytics": "Cross-channel journey analysis over stitched customer datasets.",
  "Adobe Target": "Experimentation and personalization with audiences, offers, and activities.",
  "Adobe Campaign": "Lifecycle campaign execution for targeted marketing programs.",
  Marketo: "Lead nurture, scoring, forms, and CRM-connected marketing automation.",
  "Adobe Launch": "Tag management for analytics, data layer rules, and Web SDK deployment.",
  "XDM Schema Design": "Data model planning for profiles, events, identities, and datasets.",
  "Offer Decisioning": "Eligibility, ranking, capping, and personalized offer selection.",
  "Identity Resolution": "Identity graph strategy for stitching customers across channels.",
  "Segment Builder": "Audience rules based on profile attributes, events, and qualification logic.",
  "Web SDK / Mobile SDK": "Client-side collection, personalization calls, consent, and AEP data capture.",
  "DULE / Data Governance": "Usage labels and enforcement for privacy-aware activation.",
  "AEP Destinations": "Audience and profile activation into marketing and partner endpoints.",
  "Salesforce Integration": "CRM data flow for leads, accounts, contacts, and campaign loops.",
  React: "Component-driven UI development with hooks, routing, and reusable patterns.",
  "Angular 6": "Structured SPA development with components, services, and routing.",
  "JavaScript ES6+": "Modern browser logic using modules, async flows, and DOM integration.",
  HTML5: "Semantic, accessible page structure and native browser capabilities.",
  CSS3: "Responsive layout, visual systems, transitions, and production styling.",
  jQuery: "Legacy DOM scripting, events, AJAX, and enterprise stack support.",
  DOMPurify: "HTML sanitization to reduce XSS risk in dynamic rendering.",
  "html-react-parser": "Controlled HTML-to-React rendering with transform support.",
  Java: "Backend services, APIs, integrations, and AEM application logic.",
  SQL: "Relational querying, reporting, and backend data troubleshooting.",
  "Apache Sling": "Resource-oriented routing, servlets, models, and request handling.",
  Maven: "Repeatable Java builds, dependencies, plugins, and package generation.",
  "Apache Solr": "Search indexing, faceting, query tuning, and retrieval.",
  "REST APIs": "HTTP service contracts, JSON payloads, auth, and integrations.",
  GraphQL: "Typed data querying for headless content and frontend consumption.",
  Jenkins: "Automated build, test, deployment, and release pipelines.",
  Docker: "Containerized development and reproducible runtime environments.",
  AWS: "Cloud hosting, storage, networking, and deployment support.",
  "Agile / Scrum": "Sprint planning, backlog refinement, demos, and delivery cadence.",
  "CI / CD": "Automated verification and deployment to reduce release risk.",
  "SSL / TLS": "HTTPS, certificates, transport security, and production hardening.",
  SEO: "Metadata, crawlability, performance, semantics, and structured content.",
  "ADA / a11y": "Keyboard, semantic, contrast, and screen-reader accessibility.",
  "GDPR / CCPA": "Consent-aware data usage, retention, and privacy controls.",
  Workfront: "Project intake, approvals, workflow tracking, and delivery coordination.",
  GIT: "Branching, reviews, merge discipline, and release-safe collaboration.",
  Confluence: "Technical docs, decision logs, runbooks, and stakeholder notes.",
};
...
export const HOME_SKILLS = SKILLS.map((group) => ({
  ...group,
  items: group.featured || group.items.slice(0, 6),
}));
...
export const TESTIMONIALS = [
  ...
  {
    quote:
      "A rare blend of Adobe-cert-deep lead and pragmatic engineer. Identity, governance, and personalization — he owns the whole stack.",
    name: "",
